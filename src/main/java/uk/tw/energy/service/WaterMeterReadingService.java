 ...
 */
@Service
public class WaterMeterReadingService implements MeterReadingService<ElectricityReading> {

    private final Map<String, List<ElectricityReading>> meterAssociatedReadings;

    public WaterMeterReadingService(Map<String, List<ElectricityReading>> meterAssociatedReadings) {
