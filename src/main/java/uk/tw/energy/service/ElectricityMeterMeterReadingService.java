 ...
 */
@Service
public class ElectricityMeterMeterReadingService implements MeterReadingService<ElectricityReading> {

    private final Map<String, List<ElectricityReading>> meterAssociatedReadings;

    public ElectricityMeterMeterReadingService(Map<String, List<ElectricityReading>> meterAssociatedReadings) {
